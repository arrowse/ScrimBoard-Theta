...
class Debugging(commands.Cog):
    ...
    async def configure_error(self, interaction):
        embed = discord.Embed(
            title="Sync-here",
            description="ScrimBoard developer permissions are required to manage ScrimBoard's command interface. Please check "
                        "your permissions and try again, or contact an admin for the bot.",
